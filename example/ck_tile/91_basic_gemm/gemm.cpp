...
auto create_args(int argc, char* argv[])
{
    ...
    arg_parser.insert("m", "3328", "m dimension")
        ...
        .insert("verification", "1", "cpu validation or not")
...
bool run(const ck_tile::ArgParser& arg_parser)
{
    ...
    ck_tile::index_t verification = arg_parser.get_int("verification");
    ...
    // ck_tile::HostTensor<CDataType> c_host_dev({M, N});
    ...
    // Step 2.1: Define alignment number, thread block size, shape of each tile
    ...
    if (verification)
    {
        ...
        ck_tile::reference_basic_gemm<ADataType, ADataType, AccDataType, CDataType>(a_host,
                                                                           b_host,
                                                                           c_host_ref);
