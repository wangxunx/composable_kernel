...
// Step 4: VectorAdd Pipeline
// Step 4.1 Struct of VectorAdd Kernel
template <typename Problem_, typename Policy_ = VectorAddDefaultPolicy>
struct VectorAdd
{
    ...
    {
        // Step 4.2 initialize tensor view​
        using S = typename Problem::BlockShape;
        ...
        // Step 4.3 initialize tile window​
        ...
        // Step 4.4 setup loop information and run the loop with each tile​
